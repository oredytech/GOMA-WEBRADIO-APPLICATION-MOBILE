...
export const Route = createFileRoute("/parametres")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Mode sombre, notifications, qualité de streaming et téléchargements.",
      },
    ...
    <Screen title="Paramètres" back>
      <div className="mt-4 space-y-3">
        ...
        <Toggle
          ...
          label="Notifications"
          desc="Alertes info, épisodes et vidéos"
        />
        <Toggle
          on={wifi}
          onChange={setWifi}
          label="Téléchargement en Wi-Fi uniquement"
          desc="Économisez vos données mobiles"
        />
